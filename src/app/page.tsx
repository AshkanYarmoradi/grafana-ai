...
export default function Home() {
    ...
    return (
        <main
            className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-100 dark:from-gray-900 dark:via-indigo-950 dark:to-purple-950 py-8 px-4 overflow-hidden">
            <div className="max-w-4xl mx-auto relative">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        <div className="space-y-3">
                            ...
                            >
                                ...
                                />
                                <div
                                    className="absolute inset-0 rounded-xl pointer-events-none border border-indigo-300 dark:border-indigo-600 opacity-0 focus-within:opacity-100 transition-opacity duration-300"></div>
                            </motion.div>
                        </div>
                ...
                >
                    <p>Powered by ❤️ From <a href={"https://github.com/AshkanYarmoradi/grafana-ai"}>Lena and Nina
                        Dad</a></p>
                </motion.footer>
            </div>
        </main>
